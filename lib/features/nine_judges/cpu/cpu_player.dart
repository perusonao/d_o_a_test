...
abstract final class CpuPlayer {
  static CpuStrategy strategyFor(
    CpuLevel level,
    Random random,
  ) => switch (level) {
    CpuLevel.random => RandomCpuStrategy(random),
    CpuLevel.balanced => HeuristicCpuStrategy(CpuProfile.balanced, random),
    CpuLevel.aggressive => HeuristicCpuStrategy(CpuProfile.aggressive, random),
    CpuLevel.defensive => HeuristicCpuStrategy(CpuProfile.defensive, random),
