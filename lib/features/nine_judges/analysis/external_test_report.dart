...
/// Shared external-test aggregation/KPI logic used by both the offline CLI
/// (tool/run_external_test_analysis.dart) and the admin web dashboard, so the
...
extension KpiVerdictLabel on KpiVerdict {
...
class ExternalTestReport {
  ...
  /// Sample-size caveat — never treat a handful of human testers like the
  /// 50,000-game CPU simulations.
  String get sampleSizeCaveat => switch (uniqueTesterCount) {
    0 => 'テストプレイヤーがいません。',
  ...
  String toMarkdown() {
    ...
    final buffer = StringBuffer()
      ...
      ..writeln()
      ..writeln('**サンプル数について: $sampleSizeCaveat**')
